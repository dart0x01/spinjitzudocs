# 📄 Documentation For Spinjitzu
Additional expanded documentation, guidelines, and policies for the server may be public here.
This information is provided AS-IS and it not intended to be used as a perfectly accurate and updated source.

We will aim to keep this information updated with our policies, but, it may fall out of update.
Please use the main server rules as the primary source for understanding our policies.
